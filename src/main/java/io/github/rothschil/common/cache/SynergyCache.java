...
import io.github.rothschil.common.cache.redis.CustomizedRedisCache;
...
public class SynergyCache extends AbstractValueAdaptingCache {
     ...
     */
    public SynergyCache(String name, byte[] prefix, RedisOperations<? extends Object, ? extends Object> redisOperations,
